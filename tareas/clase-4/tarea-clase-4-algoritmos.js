...
/*Desafío de programación #3: Imprimí la tabla de multiplicación del 7
 ...
 7x9 = 63
*/
function tablasDeMultiplicacion(numero) {
	for (let i = 0; i <= 10; i++) {
...
function convertidorDeCelsiusAFahrenheit() {
	const gradosCelsius = Number(prompt('Ingrese los grados Celsius a convertir por favor'));

	return `${gradosCelsius}°C son ${(gradosCelsius * 9) / 5 + 32}°F`;
}

/*Desafío de programación #9: Crea una función que convierta de Fahrenheit a Celsius*/

function convertidorDeFahrenheitACelsius() {
	const gradosFahrenheit = Number(prompt('Ingrese los grados Fahrenheit a convertir por favor'));

	return `${gradosFahrenheit}°F son ${((gradosFahrenheit - 32) * 5) / 9}°F`;
}

/*Desafío de programación #10: Calcula la suma de todos los números en un array de números*/

function sumatoriaDeNumeros(arrayConNumeros) {
	let sumatoria = 0;

	for (let i = 0; i < arrayConNumeros.length; i++) {
		sumatoria += variable[i];
	}
...
function promedioDeNotas(notas) {
	...
	return `El promedio general es de ${sumatoriaNotas / notas.length}`;
}

/*Desafío de programación #12: Crea una función que reciba un array de números y devuelva un array conteniendo solo los números positivos*/

function numeroPositivos(array) {
...
function fibonacciSeries() {
	...
	for (let i = 2; i <= 10; i++) {
		let newFibonacci = nextFibonacci + Fibonacci;
...
//DE MOMENTO NO SOLUCIONABLE POR MI CEREBRO
...
function sumaPositivos(number) {
	let sumatoria = 0;

	for (let i = 0; i < String(number).trim().length; i++) {
		const interNumber = String(number).charAt(i);

		sumatoria += Number(interNumber);
	}
